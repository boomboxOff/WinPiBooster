...
2026-02-24 10:00:00 [INFO]: WinPiBooster v2.16.0 — actif depuis 0m 0s | vérifications: 0 | installées: 0 | erreurs: 0
...
```bat
go build -ldflags="-s -w -X main.version=v2.16.0" -o WinPiBooster.exe .
```
